...
int main() {
  ...
  // op type
  const std::string op_type = "MatMul";
  // shape
  const int64_t M = 3;
  const int64_t K = 4;
  const int64_t N = 5;
  // input - x1
  const std::vector<int64_t> x1_dims{2,4};
  std::vector<float> x1_data{0.6964692,0.28613934,0.22685145,0.5513148, 0.71946895,0.42310646,0.9807642,0.6848297};
  // input - x2
  const std::vector<int64_t> x2_dims{4,2};
  std::vector<float> x2_data{0.5,0,0,0.5,0.5,0,0,0.5};
  ...
  ACL_CALL(aclopSetAttrBool(attr, "transpose_x1", trans_x1));
  ACL_CALL(aclopSetAttrBool(attr, "transpose_x2", trans_x2));
